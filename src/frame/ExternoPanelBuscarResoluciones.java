 ...
 * @author Jhon Lopez
 */
public class ExternoPanelBuscarResoluciones extends javax.swing.JPanel {

    public List listaResolucion = new ArrayList();
    public String resolucion = "";
    public int posicion;
    private PanelResoluciones panelResoluciones = new PanelResoluciones();

    /**
     * Creates new form ExternoPanelFktercero
     */
    public ExternoPanelBuscarResoluciones(PanelResoluciones panelResolucion) {
        initComponents();
        this.panelResoluciones = panelResolucion;
    }
    ...
    private void TextFieldTerceroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextFieldTerceroKeyReleased
        ...
        listaResolucion = ClaseGeneral.controlResoluciones.findAllInResolucionAndTercerosresolucionesBy();

        DefaultListModel modeloLista = new DefaultListModel();
        for (int i = 0; i < listaResolucion.size(); i++) {
            ClaseGeneral.resoluciones = (Resoluciones) listaResolucion.get(i);
            modeloLista.addElement(ClaseGeneral.resoluciones.getResolucionPK().getId() + " - " + ClaseGeneral.resoluciones.getResolucionPK().getAno());
        }
    ...
    private void listaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listaValueChanged
        ...
        if (laLista.isSelectionEmpty()) {
            ...
            resolucion = "" + laLista.getSelectedValue();
            posicion = laLista.getSelectedIndex();
            ClaseGeneral.resoluciones = (Resoluciones) listaResolucion.get(posicion);
            panelResoluciones.metodoConsultar();
        }
