 ...
 * @author Jhon Lopez
 */
public class IFrameCumplidoscomprobantes extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private ClaseInformacion informacion = new ClaseInformacion();
    private PanelCumplidoscomprobantes panelPrincipal = new PanelCumplidoscomprobantes();
     ...
     */
    public IFrameCumplidoscomprobantes() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelCumplidoscomprobantes();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlCumplidoscomprobantes.findAllInCumplidoscomprobantesByFkcomprobante(ClaseGeneral.comprobantes.getId(), ClaseGeneral.comprobantes.getAno());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.cumplidoscomprobantes = (Cumplidoscomprobantes) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameCumplidoscomprobantes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    class ThreadCarga extends Thread {
        ...
        public void run() {
             ...
             */
            try {
                if (ClaseGeneral.cumplidoscomprobantes != null) {
                    Map parametros = new HashMap();
                    parametros.put("CONTENIDO", ClaseGeneral.cumplidoscomprobantes.getContenido());
                    parametros.put("FKTERCEROFUNCIONARIO", ClaseGeneral.cumplidoscomprobantes.getFktercerofuncionario());

                    ClaseInformes informes = new ClaseInformes();
                    informes.formatoCumplido(parametros);
                }
            } catch (Exception e) {
