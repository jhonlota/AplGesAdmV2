...
public class IFrameContratosProponentes extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelContratosProponentes panelPrincipal = new PanelContratosProponentes();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameContratosProponentes() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelContratosProponentes();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.contratosProponentes = (ContratosProponentes) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameContratosProponentes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
