...
/*
 * IFrameServiciosSolicitudesOferta.java
 *
 ...
 * @author Jhon Lopez
 */
public class IFrameServiciossolicitudesoferta extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelServiciossolicitudesoferta panelPrincipal = new PanelServiciossolicitudesoferta();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameServiciossolicitudesoferta() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelServiciossolicitudesoferta();
...
//        }
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.serviciossolicitudesoferta = (Serviciossolicitudesoferta) lista.get(posicion);
...
//        }
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameServiciossolicitudesoferta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
