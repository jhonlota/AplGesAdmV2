 ...
 * @author Jhon Lopez
 */
public class IFrameResoluciones extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelResoluciones panelPrincipal = new PanelResoluciones();
    ...
    private void initComponents() {
        ...
        ano.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014", "2015", "2016", "2017" }));
        ano.setSelectedItem(ClaseGeneral.controlUtilidades.anoServidor());
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelResoluciones();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlResoluciones.findAllInResolucionByORDERBYAno(Integer.parseInt("" + ano.getSelectedItem()));

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.resoluciones = (Resoluciones) lista.get(posicion);
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ExternoPanelBuscarResoluciones panelResoluciones = new ExternoPanelBuscarResoluciones(panelPrincipal);
        ClaseMensaje.panel(panelResoluciones);

        if (panelResoluciones.resolucion.equals("")) {
            posicion = -1;
            metodoLimpiar();
            metodoEstado("reiniciar");
        } else {
            lista = panelResoluciones.listaResolucion;

            posicion = panelResoluciones.posicion;
            ClaseGeneral.resoluciones = (Resoluciones) lista.get(posicion);
            panelPrincipal.metodoConsultar();
    ...
    public void metodoBuscar(int intAno) {
        ...
        lista = ClaseGeneral.controlResoluciones.findAllInResolucionByORDERBYAno(intAno);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            if (ClaseGeneral.perfil.equals("usuario")
                    && estado.equals("nuevo")) {
                panelPrincipal.fecha.setEnabled(false);
            ...
            Logger.getLogger(IFrameResoluciones.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    class ThreadCarga extends Thread {
        ...
        public void run() {
             ...
             */
            try {
                if (ClaseGeneral.resoluciones != null
                        && !ClaseGeneral.resoluciones.getAcuerdo().equals("No Aplica")
                        && !ClaseGeneral.resoluciones.getTipo().equals("CANDIDATOS A ELECCIONES")
                        && !ClaseGeneral.resoluciones.getTipo().equals("DOCENTES OCASIONALES")) {
                    Map parametros = new HashMap();
                    parametros.put("fkterceroordenadorgasto", ClaseInformacion.ConvertirNombre(ClaseGeneral.resoluciones.getFkterceroordenadorgasto().substring(
                            ClaseGeneral.resoluciones.getFkterceroordenadorgasto().indexOf(" - ") + 3,
                            ClaseGeneral.resoluciones.getFkterceroordenadorgasto().length())));
                    parametros.put("id", ClaseGeneral.resoluciones.getResolucionPK().getId());
                    parametros.put("ano", ClaseGeneral.resoluciones.getResolucionPK().getAno());

                    ClaseInformes informes = new ClaseInformes();
                    informes.formatoResolucion(parametros);
                }
            } catch (Exception e) {
