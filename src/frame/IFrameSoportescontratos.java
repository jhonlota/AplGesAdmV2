 ...
 * @author Jhon Lopez
 */
public class IFrameSoportescontratos extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelSoportescontratos panelPrincipal = new PanelSoportescontratos();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameSoportescontratos() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelSoportescontratos();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlSoportescontratos.findAllInSoportescontratosByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.soportescontratos = (Soportescontratos) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameSoportescontratos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
