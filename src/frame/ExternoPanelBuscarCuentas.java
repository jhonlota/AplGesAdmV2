 ...
 * @author Jhon Lopez
 */
public class ExternoPanelBuscarCuentas extends javax.swing.JPanel {

    public List listaCuenta = new ArrayList();
    public String cuenta = "";
    public int posicion;
    private PanelCuentas panelCuentas = new PanelCuentas();

    /**
     * Creates new form ExternoPanelFktercero
     */
    public ExternoPanelBuscarCuentas(PanelCuentas panelCuentas) {
        initComponents();
    ...
    private void TextFieldTerceroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextFieldTerceroKeyReleased
        ...
        listaCuenta = ClaseGeneral.controlCuentas.findAllInCuentasAndSoportescuentasBy();

        DefaultListModel modeloLista = new DefaultListModel();
        for (int i = 0; i < listaCuenta.size(); i++) {
            ClaseGeneral.cuentas = (Cuentas) listaCuenta.get(i);
            modeloLista.addElement(ClaseGeneral.cuentas.getSoporte() + " - " + ClaseGeneral.cuentas.getFktercero());
        }
    ...
    private void listaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listaValueChanged
        ...
        if (laLista.isSelectionEmpty()) {
            ...
            cuenta = "" + laLista.getSelectedValue();
            posicion = laLista.getSelectedIndex();
            ClaseGeneral.cuentas = (Cuentas) listaCuenta.get(posicion);
            panelCuentas.metodoConsultar();
        }
