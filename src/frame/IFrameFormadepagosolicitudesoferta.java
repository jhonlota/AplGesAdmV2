 ...
 * @author Jhon Lopez
 */
public class IFrameFormadepagosolicitudesoferta extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelFormadepagosolicitudesoferta panelPrincipal = new PanelFormadepagosolicitudesoferta();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameFormadepagosolicitudesoferta() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelFormadepagosolicitudesoferta();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.formadepagosolicitudesoferta = (Formadepagosolicitudesoferta) lista.get(posicion);
