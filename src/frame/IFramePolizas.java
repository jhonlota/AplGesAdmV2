 ...
 * @author Jhon Lopez
 */
public class IFramePolizas extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelPolizas panelPrincipal = new PanelPolizas();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /** Creates new form IFrameContrato */
    public IFramePolizas() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelPolizas();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlPolizas.findAllInPolizasByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.polizas = (Polizas) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFramePolizas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
