 ...
 * @author Jhon Lopez
 */
public class IFrameTercerosresoluciones extends javax.swing.JInternalFrame {
    
    private List lista = new ArrayList();
    private int posicion;
    private PanelTercerosresoluciones panelPrincipal = new PanelTercerosresoluciones();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameTercerosresoluciones() {
        initComponents();
        //datos.conectar();
    }
...
//        if (ClaseInformacion.ValidarCINFO("" + panelPrincipal.cinfo.getSelectedItem())
//                && ClaseInformacion.ValidarCUENTAINTERNA("" + panelPrincipal.cuentainterna.getSelectedItem())) {
        panelPrincipal.metodoInsertar();
//            if (ClaseGeneral.controlTercerosresolucion.verify(ClaseGeneral.tercerosresolucion)) {
        metodoLimpiar();
