 ...
 * @author Jhon Lopez
 */
public class IFrameObservacionescontratos extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private ClaseInformacion informacion = new ClaseInformacion();
    private PanelObservacionescontratos panelPrincipal = new PanelObservacionescontratos();
     ...
     */
    public IFrameObservacionescontratos() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelObservacionescontratos();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlObservacionescontratos.findAllInObservacionescontratosByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.observacionescontratos = (Observacionescontratos) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameObservacionescontratos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    class ThreadCarga extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parametros.put("DEPENDENCIA", ClaseGeneral.observacionescontratos.getDependencia());
                parametros.put("FECHA", ClaseInformacion.ConvertirFecha(ClaseGeneral.observacionescontratos.getObservacionescontratosPK().getFecha()));
                parametros.put("OBSERVACION", (ClaseGeneral.observacionescontratos.getObservacion().contains("DEVOLVER A DEPENDENCIA")
                        ? ClaseGeneral.observacionescontratos.getObservacion().substring(32)
                        : ClaseGeneral.observacionescontratos.getObservacion()));
                parametros.put("SOPORTE", ClaseGeneral.observacionescontratos.getObservacionescontratosPK().getFkcontrato());
                parametros.put("MONTO", ClaseGeneral.contratos.getValor());
                parametros.put("TIPO", ClaseGeneral.controlSoportescontratos.findTipoInSoportescontratosByFkcontratoRESGITRO(ClaseGeneral.observacionescontratos.getObservacionescontratosPK().getFkcontrato()));
