 ...
 * @author Jhon Lopez
 */
public class IFrameSoportescuentas extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelSoportescuentas panelPrincipal = new PanelSoportescuentas();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameSoportescuentas() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelSoportescuentas();
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        if (ClaseInformacion.ValidarCUENTA("" + panelPrincipal.cuenta.getText())
                ...
                && (panelPrincipal.cuentainterna.getSelectedItem().equals(ClaseInformacion.ValidarIngresoCUENTAINTERNA("" + panelPrincipal.cinfo.getSelectedItem(),
                        "" + panelPrincipal.cingreso.getText(),
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.soportescuentas = (Soportescuentas) lista.get(posicion);
...
//                panelPrincipal.cuenta.setFocusable(false);
//                panelPrincipal.actividad.setFocusable(false);
//                panelPrincipal.subgrupo.setFocusable(false);
//                panelPrincipal.cingreso.setFocusable(false);
//                panelPrincipal.ccostos.setFocusable(false);
//                panelPrincipal.cinfo.setFocusable(false);
//                panelPrincipal.cuentainterna.setFocusable(false);
//                panelPrincipal.valor.setFocusable(false);
//            }
        } catch (SQLException ex) {
            Logger.getLogger(IFrameSoportescuentas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
