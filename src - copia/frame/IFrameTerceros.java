 ...
 * @author Jhon Lopez
 */
public class IFrameTerceros extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelTerceros panelPrincipal = new PanelTerceros();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /** Creates new form IFrameTerceross */
    public IFrameTerceros() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelTerceros();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlTerceros.findAllInTercerosByEntities();

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.terceros = (Terceros) lista.get(posicion);
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ExternoPanelBuscarTerceros panelTercero = new ExternoPanelBuscarTerceros(panelPrincipal);
        ClaseMensaje.panel(panelTercero);

        if (panelTercero.tercero.equals("")) {
            posicion = -1;
            metodoLimpiar();
            metodoEstado("reiniciar");
        } else {
            lista = panelTercero.listaTercero;

            posicion = panelTercero.posicion;
            ClaseGeneral.terceros = (Terceros) lista.get(posicion);
            panelPrincipal.metodoConsultar();
    ...
    public void metodoBuscar() {
        ...
        lista = ClaseGeneral.controlTerceros.findAllInTercerosBy();
        ...
        if (!lista.isEmpty()) {
            ...
            posicion = -1;
            ClaseMensaje.error("El Tercero NO existe.");
            metodoLimpiar();
            metodoEstado("reiniciar");
        }
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameTerceros.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
