...
/*
 * PanelBienesSolicitudesOFerta.java
 *
 ...
 * @author Jhon Lopez
 */
public class PanelBienessolicitudesoferta extends javax.swing.JPanel {
     ...
     */
    public PanelBienessolicitudesoferta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanelCaracteristicasminimas.getAccessibleContext().setAccessibleName("CARACTERÍSTICAS ESPECÍFICAS MÍNIMAS");
    ...
    public void metodoInsertar() {
        ...
        ClaseGeneral.bienessolicitudesoferta.setNombre(nombre.getText());
        ClaseGeneral.bienessolicitudesoferta.setDescripcion(descripcion.getText());
        ClaseGeneral.bienessolicitudesoferta.setCaracteristicas(caracteristicas.getText());
        ClaseGeneral.bienessolicitudesoferta.setCantidad(Integer.parseInt(""+cantidad.getText()));  

        if (ClaseGeneral.controlBienessolicitudesoferta.verify(ClaseGeneral.bienessolicitudesoferta)) {
            try {
                ClaseGeneral.controlBienessolicitudesoferta.create(ClaseGeneral.bienessolicitudesoferta);
            } catch (Exception ex) {
                Logger.getLogger(PanelBienessolicitudesoferta.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    public void metodoConsultar() {
        try {
            fksolicitudoferta.setText("" + ClaseGeneral.bienessolicitudesoferta.getBienessolicitudesofertaPK().getFksolicitudoferta());
            nombre.setText(ClaseGeneral.bienessolicitudesoferta.getNombre());
            descripcion.setText(ClaseGeneral.bienessolicitudesoferta.getDescripcion());
            caracteristicas.setText(ClaseGeneral.bienessolicitudesoferta.getCaracteristicas());
            cantidad.setText(""+ClaseGeneral.bienessolicitudesoferta.getCantidad());
    ...
    public void metodoActualizar() {
        ...
        Bienessolicitudesoferta bienessolicitudesofertaId = ClaseGeneral.bienessolicitudesoferta;
        bienessolicitudesofertaId.setBienessolicitudesofertaPK(ClaseGeneral.bienessolicitudesoferta.getBienessolicitudesofertaPK());
        ...
        if (ClaseGeneral.controlBienessolicitudesoferta.verify(ClaseGeneral.bienessolicitudesoferta)) {
            try {
                ClaseGeneral.controlBienessolicitudesoferta.edit(ClaseGeneral.bienessolicitudesoferta, bienessolicitudesofertaId);
            } catch (Exception ex) {
                Logger.getLogger(PanelBienessolicitudesoferta.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void metodoEliminar() {
        try {
            ...
            ClaseGeneral.controlBienessolicitudesoferta.destroy(ClaseGeneral.bienessolicitudesofertaPK);
        } catch (Exception ex) {
            Logger.getLogger(PanelBienessolicitudesoferta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void metodoMostrar() {
        ...
        for (Object lista1 : lista) {
            ...
            jTable.setValueAt("" + ClaseGeneral.bienessolicitudesoferta.getNombre(), i, 0);
            jTable.setValueAt("" + ClaseGeneral.bienessolicitudesoferta.getDescripcion(), i, 1);
            jTable.setValueAt("" + ClaseGeneral.bienessolicitudesoferta.getCaracteristicas(), i, 2);
            jTable.setValueAt("" + ClaseGeneral.bienessolicitudesoferta.getCantidad(), i, 3);
            i++;
        }
