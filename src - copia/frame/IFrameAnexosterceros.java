 ...
 * @author Jhon Lopez
 */
public class IFrameAnexosterceros extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelAnexosterceros panelPrincipal = new PanelAnexosterceros();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /** Creates new form IFrameContrato */
    public IFrameAnexosterceros() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(173, 213, 247));
        setTitle("Anexos");
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelAnexosterceros();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlAnexosterceros.findAllInAnexostercerosByFktercero(ClaseGeneral.terceros.getId() + " - " + ClaseGeneral.terceros.getNombre());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.anexosterceros = (Anexosterceros) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameAnexosterceros.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
