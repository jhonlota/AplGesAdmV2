 ...
 * @author Jhon Lopez
 */
public class IFrameObservacionescuentas extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private ClaseInformacion informacion = new ClaseInformacion();
    private PanelObservacionescuentas panelPrincipal = new PanelObservacionescuentas();
     ...
     */
    public IFrameObservacionescuentas() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelObservacionescuentas();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlObservacionescuentas.findAllInObservacionescuentasByFkcuenta(ClaseGeneral.cuentas.getSoporte());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.observacionescuentas = (Observacionescuentas) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameObservacionescuentas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    class ThreadCarga extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                parametros.put("DEPENDENCIA", ClaseGeneral.observacionescuentas.getDependencia());
                parametros.put("FECHA", ClaseInformacion.ConvertirFecha(ClaseGeneral.observacionescuentas.getObservacionescuentasPK().getFecha()));
                parametros.put("OBSERVACION", (ClaseGeneral.observacionescuentas.getObservacion().contains("DEVOLVER A DEPENDENCIA")
                        ? ClaseGeneral.observacionescuentas.getObservacion().substring(32)
                        : ClaseGeneral.observacionescuentas.getObservacion()));
                parametros.put("SOPORTE", ClaseGeneral.observacionescuentas.getObservacionescuentasPK().getFkcuenta());
