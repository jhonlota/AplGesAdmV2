 ...
 * @author Jhon Lopez
 */
public class IFrameFormadepagocontratos extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelFormadepagocontratos panelPrincipal = new PanelFormadepagocontratos();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameFormadepagocontratos() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelFormadepagocontratos();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlFormadepagocontratos.findAllInFormadepagocontratosByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.formadepagocontratos = (Formadepagocontratos) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameFormadepagocontratos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
