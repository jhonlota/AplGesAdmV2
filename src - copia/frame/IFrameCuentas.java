 ...
 * @author Jhon Lopez
 */
public class IFrameCuentas extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelCuentas panelPrincipal = new PanelCuentas();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameCuentas() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelCuentas();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlCuentas.findAllInCuentasByEntities();

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.cuentas = (Cuentas) lista.get(posicion);
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ExternoPanelBuscarCuentas panelCuentas = new ExternoPanelBuscarCuentas(panelPrincipal);
        ClaseMensaje.panel(panelCuentas);

        if (panelCuentas.cuenta.equals("")) {
            posicion = -1;
            metodoLimpiar();
            metodoEstado("reiniciar");
        } else {
            lista = panelCuentas.listaCuenta;

            posicion = panelCuentas.posicion;
            ClaseGeneral.cuentas = (Cuentas) lista.get(posicion);
            panelPrincipal.metodoConsultar();
    ...
    private void botonAccionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAccionesActionPerformed
        ExternoPanelAccionesCuentas panelAccionesCuentas = new ExternoPanelAccionesCuentas();

        if (ClaseGeneral.perfil.equals("usuario")) {
            panelAccionesCuentas.accion.setEnabled(false);
        }

        int opcion = ClaseMensaje.panel(panelAccionesCuentas);
        if (opcion == JOptionPane.YES_OPTION) {
            panelAccionesCuentas.metodoInsertar();
        }
}//GEN-LAST:event_botonAccionesActionPerformed

    public void botonCalificacionTramites() {
    ...
    public void metodoBuscar() {
        ...
        lista = ClaseGeneral.controlCuentas.findAllInCuentasBy();
        ...
        if (!lista.isEmpty()) {
            ...
            posicion = -1;
            ClaseMensaje.error("La Cuentas NO existe.");
            metodoLimpiar();
            metodoEstado("reiniciar");
        }
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            if (ClaseGeneral.perfil.equals("usuario")
                    && estado.equals("nuevo")) {
                panelPrincipal.documento.setFocusable(false);
                panelPrincipal.ingreso.setFocusable(false);
                panelPrincipal.cuentacontrol.setFocusable(false);
                panelPrincipal.fechadigitacion.setEnabled(false);
                panelPrincipal.fechapresupuestal.setEnabled(false);
                panelPrincipal.fechatransaccion.setEnabled(false);
            ...
            Logger.getLogger(IFrameCuentas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
