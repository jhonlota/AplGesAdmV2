 ...
 * @author Jhon Lopez
 */
public class IFrameAnexoscontratos extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelAnexoscontratos panelPrincipal = new PanelAnexoscontratos();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /**
     * Creates new form IFrameContrato
     */
    public IFrameAnexoscontratos() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelAnexoscontratos();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlAnexoscontratos.findAllInAnexoscontratosByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.anexoscontratos = (Anexoscontratos) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            datos.query("SELECT * FROM ESTADOS " + 
                    "WHERE " + 
                    "VENTANA = '" + panelPrincipal.getName() + "' AND " + 
                    "USUARIO = '" + ClaseGeneral.perfil + "' AND " + 
                    "ESTADO = '" + estado + "'");
            ...
            Logger.getLogger(IFrameAnexoscontratos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
