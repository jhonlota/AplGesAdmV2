 ...
 * @author Jhon Lopez
 */
public class IFrameFacturascomprobantes extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private ClaseInformacion informacion = new ClaseInformacion();
    private PanelFacturascomprobantes panelPrincipal = new PanelFacturascomprobantes();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /** Creates new form IFrameContrato */
    public IFrameFacturascomprobantes() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelFacturascomprobantes();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlFacturascomprobantes.findAllInFacturascomprobantesByFkcomprobante(ClaseGeneral.comprobantes.getId(), ClaseGeneral.comprobantes.getAno());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.facturascomprobantes = (Facturascomprobantes) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameFacturascomprobantes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
