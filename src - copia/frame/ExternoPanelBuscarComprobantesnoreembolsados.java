 ...
 * @author Jhon Lopez
 */
public class ExternoPanelBuscarComprobantesnoreembolsados extends javax.swing.JPanel {

    public List listaComprobantenoreembolsados = new ArrayList();
    public String comprobantenoreembolsados = "";
    public int posicion;
    private PanelComprobantesnoreembolsados panelComprobantesnoreembolsados;

    /**
     * Creates new form ExternoPanelFktercero
     */
    public ExternoPanelBuscarComprobantesnoreembolsados(PanelComprobantesnoreembolsados panelComprobantesnoreembolsados) {
        initComponents();
        this.panelComprobantesnoreembolsados = panelComprobantesnoreembolsados;
    }
    ...
    private void initComponents() {
        ...
        parametro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FORMA DE PAGO (ESTADO) [upper(tipopago)]", "NÚMERO DE COMPROBANTE [CAST(comprobante AS TEXT)]", "FECHA DEL PAGO [CAST(fechaaplicacion AS TEXT)]" }));
    ...
    private void TexyFieldTerceroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TexyFieldTerceroKeyReleased
        ...
        listaComprobantenoreembolsados = ClaseGeneral.controlComprobantes.findAllInComprobantesnoreembolsadosByFechaaplicacion();

        DefaultListModel modeloLista = new DefaultListModel();
        for (int i = 0; i < listaComprobantenoreembolsados.size(); i++) {
            ClaseGeneral.comprobantesnoreembolsados = (Comprobantes) listaComprobantenoreembolsados.get(i);
            modeloLista.addElement(ClaseGeneral.comprobantesnoreembolsados.getFechaaplicacion() + " - " + ClaseGeneral.comprobantesnoreembolsados.getAno());
        }
    ...
    private void listaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listaValueChanged
        ...
        if (laLista.isSelectionEmpty()) {
            comprobantenoreembolsados = "";
            posicion = -1;
            return;
        } else {
            comprobantenoreembolsados = "" + laLista.getSelectedValue();
            posicion = laLista.getSelectedIndex();
            ClaseGeneral.comprobantesnoreembolsados = (Comprobantes) listaComprobantenoreembolsados.get(posicion);
            panelComprobantesnoreembolsados.metodoConsultar();
        }
