 ...
 * @author Jhon Lopez
 */
public class IFrameModificaciones extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelModificaciones panelPrincipal = new PanelModificaciones();
    private ClaseBaseDatos datos = new ClaseBaseDatos();

    /** Creates new form IFrameContrato */
    public IFrameModificaciones() {
        initComponents();
        //datos.conectar();
    }
    ...
    private void botonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonNuevoActionPerformed
        ...
        panelPrincipal = new PanelModificaciones();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlModificaciones.findAllInModificacionesByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.modificaciones = (Modificaciones) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameModificaciones.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
