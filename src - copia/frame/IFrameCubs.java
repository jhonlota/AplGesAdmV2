 ...
 * @author Jhon Lopez
 */
public class IFrameCubs extends javax.swing.JInternalFrame {

    private List lista = new ArrayList();
    private int posicion;
    private PanelCubs panelPrincipal = new PanelCubs();
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        lista = ClaseGeneral.controlCubs.findAllInCubsByFkcontrato(ClaseGeneral.contratos.getContrato());

        if (!lista.isEmpty()) {
            posicion = 0;
            ClaseGeneral.cubs = (Cubs) lista.get(posicion);
    ...
    public void metodoEstado(String estado) {
        try {
            ...
            Logger.getLogger(IFrameCubs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
